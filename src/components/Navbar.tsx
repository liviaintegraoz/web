      ...
      {isMenuOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 bg-brand-ink/40 backdrop-blur-md z-[60] lg:hidden"
          />
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 w-[85%] max-w-sm bg-white z-[70] shadow-2xl lg:hidden flex flex-col"
          >
